...
public record RequestMapIdPayload() implements CustomPayload {
    public static final Id<RequestMapIdPayload> ID = new Id<>(Identifier.of(AdvancedLocate.MOD_ID, "request_map_id"));
